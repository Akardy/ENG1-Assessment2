...
public class SettingsMenu implements Screen {
    ...
    private void setupResumeButton() {
        ...
        Drawable resumeButtonDrawable = new TextureRegionDrawable(Assets.resumeButtonTexture); // Texture of credits
                                                                                               // button
        ...
        resumeButton.setSize(Consts.MAIN_MENU_BUTTON_WIDTH, Consts.MAIN_MENU_BUTTON_HEIGHT);
        resumeButton.setPosition(Consts.MAIN_MENU_BUTTON_X, Consts.MAIN_MENU_BUTTON_Y);
    }
    ...
    public void musicSlider() {
        ...
        musicLabel.setPosition(Consts.SCORE_LABEL_X, Consts.SCORE_LABEL_Y, Align.center);
